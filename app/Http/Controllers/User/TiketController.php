...
class TiketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.tiket.index', compact('data'));
    }
    public function create()
    {
        $kategori_masalah = KategoriMasalah::orderBy('created_at', 'DESC')->get();
        return view('user.tiket.create', compact('kategori_masalah'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($done) {
            return redirect('/user/tiket')->with('berhasil', 'Data berhasil ditambahkan!');
        } else {
            return redirect('/user/tiket')->with('gagal', 'Data gagal ditambahkan!');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('user.tiket.show', compact('data'));
    }

    public function lihatTanggapanTiket($id)
    {
        $data = Tiket::where('id', $id)->first();
        return view('user.tiket.tanggapan', compact('data'));
    }
    ...
    public function tidakSelesaiTiket($id)
    {
        ...
        $kategori_masalah = KategoriMasalah::orderBy('created_at', 'DESC')->get();
        return view('user.tiket.tidak_selesai', compact('tiket', 'kategori_masalah'));
    }
    ...
    public function selesaiTiket($id)
    {
        ...
        if ($done) {
            return redirect('/user/tiket')->with('berhasil', 'Data berhasil diselesaikan!');
        } else {
            return redirect('/user/tiket')->with('gagal', 'Data gagal diselesaikan!');
        }
    }
    ...
    public function logTiket($id){
        ...
        return view('user.log_tiket', compact('data', 'id_tiket'));
    }
    ...
    public function cetak(Request $request){
        ...
        return Pdf::loadView('user.laporan.cetak', compact('cetak', 'date'))->setPaper('A4', 'landscape')->stream('laporan_tiket - '. $date .'.pdf');
    }
