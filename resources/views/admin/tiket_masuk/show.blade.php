...
<div class="row justify-content-center">
    <div class="card p-4 shadow col-sm-6">
        ...
        @endif
        <form method="POST" action="/admin/tiket_masuk/{{$data->id}}/proses" onsubmit="return confirm('Apakah anda yakin ingin Proses data ini?')">
            @csrf
            @method('patch')
            <div class="card-header text-center font-weight-bold" style="font-size: larger;">Lihat Tiket Masuk</div>
            <div class="card-body">
