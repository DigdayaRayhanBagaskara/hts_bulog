    ...
    <div class="card p-4 shadow col-sm-6">
        ...
        @endif
            ...
            <div class="card-footer text-center">
                <a href="/admin/tiket_diproses/" class="btn btn-secondary">Kembali</a>
                @if($data->tanggapan == null)
                <a href="/admin/tiket_diproses/tanggapi/{{$data->id}}" class="btn btn-warning">Tanggapi</a>
                @else
                <a href="/admin/tiket_diproses/tanggapi/{{$data->id}}/show" class="btn btn-info">Tanggapan</a>
                @endif
            </div>
    </div>
</div>
